...
&nbsp;&nbsp;We can safely conclude that analyzing this dataset is not a big data problem, since it fails to satisfy the volume, variety, velocity, veracity argument.^[2]^
 
A closer look at the 4 Vs of big data will enable us to better understand this problem: 
